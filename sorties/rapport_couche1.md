...
Genere le 2026-09-05 par `src/etape1_rapport.py`, revision `733003e`. Tous les chiffres sont derives des CSV de `sorties/`, aucun n'est saisi a la main.
...
- `[FAIT]` Le perimetre carne fige (`config/perimetre.yaml`) retient **90337 produits**, dont **2382 tagues `en:halal`** et 87955 au temoin.
- `[FAIT]` 70288 produits ont des donnees nutritionnelles completes (78 % du perimetre), dont 1955 au bras halal et 68333 au temoin.
...
`[FAIT]` Sur les 1263854 produits France, seuls 2382 produits tagues halal sont carnes. Le tag `en:halal` est majoritairement porte par des produits non carnes (confiseries, snacks, boissons), hors sujet ici.
...
|:------------------------|--------:|----------------:|---------:|-----------------:|:-------------|
| autres_carnes           |     435 |             357 |    22193 |            15715 | franchie     |
...
| plats_cuisines          |     164 |             142 |    12235 |            10753 | franchie     |
| preparations_marinees   |     154 |             113 |     2491 |             1776 | franchie     |
| viande_hachee           |     119 |             104 |     1447 |             1118 | franchie     |
| decoupes                |     233 |              91 |    11357 |             6130 | franchie     |
| rillettes_pates_mousses |      40 |              39 |     6600 |             5594 | franchie     |
| foie_gras               |       1 |               1 |       85 |               77 | NON franchie |

- `autres_carnes` — Autres produits carnes : categorie OFF ne descendant pas sous l'espece : **franchie** (357 halal complets, 15715 temoins complets).
...
- `plats_cuisines` — Plats cuisines et sandwichs a base de viande : **franchie** (142 halal complets, 10753 temoins complets).
- `preparations_marinees` — Preparations marinees, cuites ou assaisonnees a base de decoupes : **franchie** (113 halal complets, 1776 temoins complets).
- `viande_hachee` — Viande hachee et steaks haches : **franchie** (104 halal complets, 1118 temoins complets).
- `decoupes` — Decoupes crues (blancs, cuisses, steaks, non assaisonnes) : **franchie** (91 halal complets, 6130 temoins complets).
...
|:------------------------|:-------|---------:|---------:|--------------:|---------------:|
| autres_carnes           | halal  |      355 |     65.9 |         11.6  |             12 |
| autres_carnes           | temoin |    15960 |     52.5 |         10.35 |             11 |
...
| decoupes                | halal  |       91 |     24.2 |          1.84 |              0 |
| decoupes                | temoin |     6503 |      3.6 |         -2.24 |             -3 |
...
| plats_cuisines          | temoin |    11059 |     19.3 |          5.46 |              4 |
| preparations_marinees   | halal  |      113 |     55.8 |          9.07 |             11 |
| preparations_marinees   | temoin |     1809 |     29.9 |          3.89 |              2 |
...
| Achahada                        |            9 |           3 |             66.7 |
| Halal Certification Germany     |            6 |           3 |             50   |
| Muslim Council International    |            4 |           1 |            100   |
| Extra Kalite                    |            4 |           2 |             50   |
| Tracabilite 100 % Halal         |            3 |           1 |            100   |
| Centre Islamique de Aachen      |            1 |           1 |            100   |
| ID Halal                        |            1 |           1 |            100   |
| World Islamic Foundation        |            1 |           1 |            100   |
...
|:-------|------:|-----------------:|------------------------:|-------------------:|
| halal  |  2382 |             98.3 |                    56.9 |               99.7 |
| temoin | 87955 |             94.2 |                    56.7 |               96.3 |
...
|:-----------------|:------------------|-------------:|-----------:|------------:|
| carrefour        | carrefour         |         2867 |         61 |         2.1 |
...
| reghalal         | Réghalal          |          147 |        129 |        87.8 |
| aia              | AIA               |           93 |         21 |        22.6 |
...
|:------------------------|----------:|-----------:|-------------------:|---------------:|---------------:|--------------------:|----------------:|----------------:|----------------:|-----------:|------------:|:--------------------|
| autres_carnes           |       357 |      15715 |               1.8  |           1.22 |           2.52 |                1.3  |            0.4  |            1.9  |            0.5  |      0.4   |        0.7  | True                |
...
| plats_cuisines          |       142 |      10753 |               1.15 |           0.9  |           1.5  |                0.87 |            0.7  |            1.1  |            0.28 |      0.13  |        0.4  | True                |
| preparations_marinees   |       113 |       1776 |               1.65 |           1.2  |           1.9  |                1    |            0.4  |            1.4  |            0.65 |      0.4   |        0.77 | True                |
| viande_hachee           |       104 |       1118 |               0.2  |           0.17 |           0.81 |                0.22 |            0.17 |            0.84 |           -0.02 |     -0.02  |        0    | True                |
| decoupes                |        91 |       6130 |               0.4  |           0.14 |           1.5  |                0.18 |            0.11 |            1.1  |            0.22 |      0.03  |        1.02 | True                |
...
| _ensemble_              |      1955 |      68332 |               1.8  |           1.2  |           2.58 |                1.5  |            0.85 |            2    |            0.3  |      0.3   |        0.4  | True                |
...
`[FAIT]` Par sous-categorie, l'ecart est en faveur du temoin (halal plus sale) dans 7 strates sur 11 avec un IC excluant zero : autres_carnes, charcuterie_cuite, panes, saucisses, plats_cuisines, preparations_marinees, decoupes.
...
|:------------------------|----:|-------------:|----------:|----------:|--------------------:|-------------:|
| autres_carnes           | 362 |         1.8  |      0.52 |      3.5  |                2.98 |         2.3  |
...
| preparations_marinees   | 116 |         1.61 |      0.87 |      2.25 |                1.38 |         2.9  |
| viande_hachee           | 105 |         0.2  |      0.14 |      1.2  |                1.06 |         8    |
| decoupes                | 102 |         0.29 |      0.1  |      2.19 |                2.09 |         0.95 |
| rillettes_pates_mousses |  39 |         1.5  |      1.21 |      2.32 |                1.11 |         6.8  |

`[FAIT]` Dans 10 strates sur 10, l'ecart interdecile INTERNE au bras halal depasse l'ecart de medianes entre bras. Le rapport des deux va de 2.1 a inf, mediane 5.9.
...
`[FAIT]` A sous-categorie egale, le bras halal est plus transforme que le temoin dans 10 strates sur 11. L'ecart median de part de produits classes NOVA 4 est de +10.6 points.

| sous_categorie          | bras   |   n_nova |   pct_nova4 |
|:------------------------|:-------|---------:|------------:|
| autres_carnes           | halal  |      119 |        86.6 |
| autres_carnes           | temoin |     6395 |        59   |
...
| decoupes                | halal  |       37 |        40.5 |
| decoupes                | temoin |     1591 |        35.5 |
| foie_gras               | halal  |        1 |         0   |
| foie_gras               | temoin |       82 |        13.4 |
| panes                   | halal  |      119 |        96.6 |
| panes                   | temoin |     1104 |        88   |
| plats_cuisines          | halal  |       88 |        90.9 |
| plats_cuisines          | temoin |     7074 |        80.3 |
| preparations_marinees   | halal  |       36 |        88.9 |
| preparations_marinees   | temoin |      787 |        75.2 |
...
`[FAIT]` La couverture NOVA est partielle : 1008 produits halal notes sur 2382, soit 42 %. Les pourcentages ci-dessus portent sur les produits notes, pas sur le perimetre.
...
`[FAIT]` Le releve manuel de la grille additifs, prevu en couche 5, porte sur 281 codes E distincts dans le perimetre, dont 112 suffisent a couvrir 99 % des occurrences.
...
`[FAIT]` L'etude est faisable. Les neuf sous-categories du perimetre franchissent la regle des 30, le bras halal compte 1955 produits a donnees completes, et les variables de sortie prevues (sel, Nutri-Score, NOVA, additifs) sont renseignees a un taux exploitable.
