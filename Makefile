...
.PHONY: install couche1 source france perimetre assertions analyse rapport \
        ...
        couche16 surcout couche17 nommer couche18 podiums couche19 seuils couche20 certif \
        amorce figer propre
...
familles:
	$(PY) $(SRC)/etape15_familles_marques.py
...
certif:
	$(PY) $(SRC)/etape20_certif_et_faconniers.py
